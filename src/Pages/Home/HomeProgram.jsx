    ...
    <>
      <div className="w-[100%] relative object-cover">
        ...
        <div className="grid grid-cols-2 w-[100%] justify-center max-xl:grid-cols-1">
          ...
          <div
            className="flex flex-col justify-center gap-[2rem] py-[8rem] px-[8rem] bg-[#f2f2f2] 
            max-2xl:px-[4rem] max-2xl:py-[4rem] max-md:px-[2rem] relative bg-[url('/Images/Academics/4.jpg')] bg-no-repeat bg-center bg-cover"
          >
            ...
            <div className="flex flex-col gap-[2rem] relative">
              ...
              <p className="text-[2rem] text-[#313131] font-medium text-justify max-sm:text-left max-sm:text-[1.6rem]">
                Welcome to our One-Year Diploma in Hotel Management. This
                program meticulously crafted for individuals aspiring to immerse
                themselves in the dynamic field of hospitality. Over the course
                of one year, you will acquire an extensive understanding of
              ...
              <div className="flex flex-col gap-[1rem] py-[2rem] max-sm:py-0">
                <div className="flex items-center gap-[1rem]">
                  ...
                  />
                  <h2 className="text-[3rem] font-medium text-[#313131] max-sm:text-[2.5rem]">
                    Diploma Program
                  </h2>
                </div>
                <div className="flex items-center gap-[1rem]">
                  ...
                  />
                  <h2 className="text-[2.5rem] font-medium text-[#313131] max-sm:text-[2rem]">
                    Hotel Management
                  </h2>
                </div>
              </div>
