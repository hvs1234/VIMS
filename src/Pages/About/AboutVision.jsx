    ...
    <>
      <div className="bg-[#f2f2f2] w-[100%] px-[0rem] max-xl:pt-0">
        ...
        <div className="grid grid-cols-2 w-[100%] max-xl:grid-cols-1">
          ...
          <div className="flex flex-col justify-center gap-[2rem] w-[100%] px-[8rem] py-[8rem] max-xl:px-[5rem] max-xl:py-[5rem] max-md:px-[2rem] max-md:py-[5rem]">
            ...
            <p className="text-[2rem] text-[#212121] font-normal max-md:text-[1.6rem]">
              ...
              consciousness. We are committed to preparing students to excel in
              the 21st century as independent thinkers who embody initiative and
              leadership qualities, equipping them to becomes global citizens.
              We encourage the development of strong ethical values and expose
              students to a modern, technology-driven environment thereby
              reinforcing our rich heritage and enhancing human potential for
            ...
            <p className="text-[2rem] text-[#212121] font-normal max-md:text-[1.6rem]">
              ...
              Hospitality Industry. Our goal is to instill a professional vigor
              that inspires students to realize their potential for employment
              or self-employment in specialized fields such as Applied
              Nutrition, Sports Nutrition, Hotel Interiors, Interior and
              Exterior Design, Furniture and Furnishing Design, and other
