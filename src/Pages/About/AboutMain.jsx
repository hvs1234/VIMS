  ...
  return (
    <>
      <div className="relative w-[100%]">
        ...
        <div
          className="pt-[6rem] pb-[6rem] px-[20rem] w-[100%] relative object-cover bg-[white] max-xl:px-[5rem] max-md:px-[2rem] max-md:py-[4rem]"
          id="aboutmain"
        >
          ...
          <div className="flex flex-col gap-[2rem] mt-[4rem]">
            ...
            <p className="text-[2rem] text-[#212121] font-normal max-md:text-[1.6rem]">
              ...
              hospitality, our Hotel Management program builds professionals who
              are not only adept in operational excellence but also in
