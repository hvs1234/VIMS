...
import AcademicsPost from "./AcademicsPost";
...
const Academics = () => {
  ...
  return (
    <>
      <Nav />
      <div
        className="relative w-[100%] h-[100%] object-cover bg-[url('/Images/Academics/5.jpg')] bg-no-repeat bg-center 
      ...
      >
        ...
        <div
          className="relative flex flex-col gap-[2rem] w-[100%] justify-end items-start mt-[20rem] max-md:mt-[10rem] 
          max-w-[80%] max-md:items-center max-md:justify-center max-md:max-w-[100%] max-md:text-center"
        >
          ...
          <div className="mt-[1rem]">
            <Link
              ...
              className="bg-[darkgreen] text-[white] px-[2rem] py-[0.5rem] text-[2rem] rounded-xl transition-all duration-[0.1s] 
